  ...
  return (
    <div className="pb-24">
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-xl text-xs leading-relaxed text-white/70 line-clamp-2 sm:mt-6 sm:text-base sm:line-clamp-none anim-fade-up anim-fade-up-delay-3">
                  Kết tinh từ trà Shan Tuyết cổ thụ và công thức topping thủ công. SMYOU mang đến trải nghiệm thưởng trà đẳng cấp App-First.
                </p>
          ...
          <div className="flex items-center gap-8 whitespace-nowrap marquee-scroll">
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex items-center gap-8">
                ...
                <span className="flex items-center gap-2 text-sm font-black text-white/80"><TicketPercent className="h-4 w-4" /> Mã SMYOU20 giảm 20K</span>
                <span className="text-white/30">•</span>
        ...
        <div className="grid gap-6 lg:grid-cols-2 stagger-children">
          ...
          <div className="relative flex min-h-[300px] flex-col items-center justify-center overflow-hidden rounded-[40px] bg-white p-8 text-center border-2 border-orange-100 group sm:p-12 card-interactive">
             ...
             <div className="relative z-10">
                ...
                <h3 className="mt-6 font-heading text-3xl font-black text-[#2D1606]">Nhập mã "SMYOU20" <br />Giảm 20K đơn 1</h3>
                ...
                <div className="mt-8 inline-flex items-center gap-3 rounded-2xl bg-orange-50 px-6 py-3 border border-orange-100 transition-colors hover:bg-orange-100/50">
                   <code className="text-lg font-black text-orange-600">SMYOU20</code>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 anim-fade-up">
         <h2 className="font-heading text-4xl font-black text-[#2D1606]">Khát là phải SMYOU.</h2>
