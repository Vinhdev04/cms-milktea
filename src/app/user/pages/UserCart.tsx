  ...
  return (
    <div className="mx-auto grid max-w-6xl gap-6 px-4 py-8 lg:grid-cols-[1fr_360px] sm:px-6">
      ...
      <aside className="space-y-6">
        ...
        <div className="surface-card rounded-[32px] p-6 bg-gray-50/50 border border-dashed border-gray-200">
          <div className="mb-2 flex items-center gap-2 text-sm font-bold uppercase tracking-[0.2em] text-gray-400">
            <TicketPercent className="h-4 w-4" /> Hệ thống Voucher
          </div>
          <p className="text-xs font-medium text-gray-400 leading-relaxed italic">
            Chức năng áp dụng mã giảm giá đang được bảo trì và sẽ sớm quay trở lại.
          </p>
        </div>
      </aside>
    </div>
