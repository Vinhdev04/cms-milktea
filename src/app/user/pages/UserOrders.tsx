                        ...
                        <div className="flex-1 p-8">
                           ...
                           <div className="flex flex-wrap gap-2">
                               {order.items.map(item => (
                                  <div key={item.name} className="flex items-center gap-3 rounded-2xl bg-[#F8F9FA] pl-2 pr-4 py-2 ring-1 ring-gray-100 transition-all duration-300 hover:ring-orange-200 hover:bg-white hover:shadow-sm">
                                     ...
                                     <div className="text-[11px] font-bold text-[#2D1606]">
                                        <span className="text-orange-600">x{item.quantity}</span> {item.name}
                                     </div>
                                  </div>
                               ))}
                           </div>
