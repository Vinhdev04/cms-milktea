      ...
      <header className="sticky top-0 z-40 border-b border-[#F0CBA8] bg-[rgba(255,250,244,0.94)] backdrop-blur-xl">
        <div className="mx-auto flex h-[68px] max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <Link to="/app" className="flex items-center gap-3 flex-shrink-0">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#FF8A1F] to-[#E56A00] text-sm font-extrabold text-white shadow-[0_8px_20px_rgba(245,130,32,0.32)]">
              SM
            </div>
            <div>
              <div className="font-heading text-base font-extrabold tracking-tight text-[#2D1606] leading-none">SMYOU</div>
