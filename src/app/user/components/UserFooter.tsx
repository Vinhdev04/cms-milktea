    ...
    <footer className="mt-16 border-t border-[#F3D9BE] bg-[linear-gradient(180deg,#FFF6EC_0%,#FFF0E0_100%)] text-[#4A2508]">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl overflow-hidden bg-white shadow-[0_4px_16px_rgba(245,130,32,0.22)]">
              <img src="/chips-logo.png" alt="Chips Logo" className="h-10 w-10 object-contain" />
            </div>
              <div>
                <div className="font-heading text-lg font-bold">Chips Delivery</div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-[#7A451A]">
              ...
              <div className="flex items-center gap-3"><Mail className="h-4 w-4 text-[#FF8A1F]" /><span>hello@chips.vn</span></div>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-[#F2D5BA] pt-6 text-sm text-[#A05A22] md:flex-row md:items-center md:justify-between">
          <p>© 2026 Chips. Orange preview for member app.</p>
