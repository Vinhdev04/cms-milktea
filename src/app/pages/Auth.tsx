...
export function Auth() {
  ...
  }, [isAuthenticated, isLoading, navigate, user?.appRole]);
  ...
  if (isLoading) {
    return <div className="flex min-h-screen items-center justify-center bg-[#FFF9F3] text-sm font-semibold text-[#9A5B2B]">Đang tải phiên đăng nhập...</div>;
  }

  return (
    <div className="flex min-h-screen w-full bg-[linear-gradient(180deg,#fffaf5_0%,#fff5ec_100%)]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <style>{`
        @keyframes kenBurns {
          0% { transform: scale(1); }
      ...
      <div className="relative hidden flex-1 overflow-hidden bg-[#3D1A00] lg:flex">
        <div
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#2A1000]/90 via-[#2A1000]/35 to-transparent" />
        ...
        <div className="absolute left-8 top-8 flex items-center gap-3">
          ...
          <div>
            <div className="text-base font-bold text-white">SMYOU</div>
      ...
      <div className="relative flex flex-1 items-center justify-center overflow-y-auto p-6 md:p-12">
        <div className="w-full max-w-[420px] animate-fade-up delay-100">
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#F58220]">
            ...
            <div>
              <div className="text-base font-bold text-[#5D2E0F]">SMYOU</div>
              <div className="text-[11px] text-[#A0845C]">MilkTea CMS</div>
            </div>
          </div>

          <div className="rounded-[28px] bg-white p-8 shadow-[0_20px_48px_rgba(0,0,0,0.08)]">
            ...
            {success && (
              <div className="mb-4 flex items-center gap-2 rounded-xl border border-[#FED7AA] bg-[#FFEDD5] px-4 py-3">
