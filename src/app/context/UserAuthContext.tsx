...
export function UserAuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = async (email: string, password: string) => {
    const mockUsers = [
      { id: 'user1', name: 'Nguyễn Văn A', email: 'user1@example.com', phone: '0901234567', loyaltyPoints: 250, tier: 'Silver' as const },
      { id: 'user2', name: 'Trần Thị B', email: 'user2@example.com', phone: '0909876543', loyaltyPoints: 500, tier: 'Gold' as const },
      { id: 'user3', name: 'Lê Minh C', email: 'user3@example.com', phone: '0912345678', loyaltyPoints: 1000, tier: 'Platinum' as const },
    ];

    const foundUser = mockUsers.find((userItem) => userItem.email === email && password === 'password123');
